    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        for touch in touches{
            ...
            if playAgainLabel.contains(location){
                let levelData: LevelData = LevelData(currentLevel: 1, tankTime: 7.0, balloonTime: 3.0, tankProjectileTime: 3.0, balloonProjectileTime: 2.0, tankDelayTime: 3.0, balloonDelayTime: 0.7 );
